                  ...
                  return TableRow(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          '${timeTakenPerQuestion[index]} seconds',
                          style: const TextStyle(fontSize: 18),
                        ),
                      ),
                    ],
...
class QuizState with ChangeNotifier {
  ...
  void _loadNextQuestion() {
    ...
    final generatedQuestion = divideAndGenerateRandomAnswers();
    _question = generatedQuestion['question'];
    _answers = generatedQuestion['answers'];
    _correctAnswer = generatedQuestion['correctAnswer'];
  ...
  Map<String, dynamic> divideAndGenerateRandomAnswers() {
